...
export class RegisterComponent implements OnInit {
  ...
  Fbicon = "https://www.pngfind.com/pngs/m/181-1815591_facebook-circle-icon-facebook-icon-png-brown-transparent.png";
  ...
  constructor(private Obj:AuthorizeService,) { }

  ngOnInit(): void {
  }
  register(){
    var group = this.userGroup.value;
    if(group.password == group.repeat){
      this.Obj.signup(group.email,group.username,group.password);
    }
    else{
      alert("repeat password corectly")
    }
  }
}
